...
<head>
	...
	function goReg(){
		...
		//	$("#ch_writeForm").append("<input type='hidden' name='option_su' value='"+document.getElementsByName('option_contents').length+"'>");
			...
			$.ajax({
				type : "POST",
				url : "problemReg",
				data : queryString + option_contents,
				async: false,
